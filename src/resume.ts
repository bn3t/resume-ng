...
export const resumeSchema = z
  .object({
    $schema: z.string().url().describe("link to the version of the schema that can validate the resume").optional(),
    basics: z
      .object({
        name: z.string(),
        ...
        phone: z.string().describe("Phone numbers are stored as strings so use any format you like, e.g. 712-117-2923"),
      ...
      .array(
        z
          .object({
            ...
            keywords: z.array(z.string().describe("e.g. HTML")).describe("List some keywords pertaining to this skill"),
          })
          .catchall(z.any()),
      )
